...
hero:
  ...
  image: 
    src: /graphs/homepage/Logo_v4.png
    alt: AEGIS Lab Logo
  actions:
    - theme: brand
      text: Portfolio
...
features:
  ...
  - title: Graph RAG
    details: Leveraging knowledge graphs to enhance retrieval precision and context-aware generation for complex queries.<img src="/graphs/homepage/RAG_demo_vertical.jpg" style="height:80%, margin-top:10px; border-radius:8px;" alt="Explainable AI">
