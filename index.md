...
features:
  - title: Medical AI
    details: Proven track record in architecting multi-stage pipelines that consistently meet rigorous clinical benchmarks, achieving reliable performance metrics (exceeding 0.8) across complex diagnostic tasks.<img src="./graphs/homepage/PARS_heatmap.png" style="margin-top:10px; border-radius:8px;" alt="Medical AI">
